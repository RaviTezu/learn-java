...
public class YardCalculator
{
   ...
   {
       double peri = 2 * (this.theLength + this.theWidth);
       return peri * METERS_PER_FOOT;
   }
   ...
   public double area()
   {
      return (this.theLength * this.theWidth) * Math.pow(METERS_PER_FOOT,2);
   }
   ...
   {
      return  METERS_PER_FOOT * Math.sqrt(Math.pow(this.theWidth,2) + Math.pow(this.theLength,2));
   }
